...
public:
    ...
    void postOrderIterative()
    {
        ...
        do
        {
            ...
            {
                if (temp->right)
                    Page 99 of 166 stack.push(temp->right);
                stack.push(temp);
                temp = temp->left;
            }
            temp = stack.pop();
    ...
    void mirror(Node<int> *current)
    {
        ...
        {
            Page 100 of 166 mirror(current->left);
...
ion\n"
 ...
 case 9:
     cout << endl;
     Page 106 of 166 cout << "Height of Tree: "
